...
@property (nonatomic) MainTabBarController *tabBar;
@property (nonatomic) PersonalTableViewController *personVC;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Bmob registerWithAppKey:@"9209200b37fb8254131912d46fe6fe09"];
    ...
    self.window.dk_backgroundColorPicker = DKColorPickerWithKey(BG);
    self.currentTime = [BaseNewsUtils getSystemCurrentTime];
    
    MainNavigationController *navi = (MainNavigationController *)self.tabBar.viewControllers.lastObject;
    self.personVC = (PersonalTableViewController *)navi.viewControllers[0];
    
    return YES;
}

-(void)shareSDKSetting{
    [ShareSDK registerApp:@"175ab43f33465"
          activePlatforms:@[
          ...
          onConfiguration:^(SSDKPlatformType platformType, NSMutableDictionary *appInfo) {
              ...
              switch (platformType)
              {
                  ...
                  case SSDKPlatformTypeWechat:
                      ...
                      break;
                  case SSDKPlatformTypeQQ:
                      [appInfo SSDKSetupQQByAppId:@"801312852"
...
//    PersonalTableViewController *vc = (PersonalTableViewController *)navi.viewControllers[0];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"no" forKey:@"ifWindow"];
    // 利用音频播放类特权实现后台注册界面倒计时功能继续运行
...
//    MainNavigationController *navi = (MainNavigationController *)self.tabBar.viewControllers.lastObject;
//    PersonalTableViewController *vc = (PersonalTableViewController *)navi.viewControllers[0];
    self.personVC.isActiveTimer = @"YES";
