...
- (DKColorPicker)dk_barTextColorPicker {
    return objc_getAssociatedObject(self, @selector(dk_barTextColorPicker));
}

- (void)dk_setBarTextColorPicker:(DKColorPicker)picker{
    objc_setAssociatedObject(self, @selector(dk_barTextColorPicker), picker, OBJC_ASSOCIATION_COPY_NONATOMIC);
    self.tintColor = picker(self.dk_manager.themeVersion);
    [self.pickers setValue:[picker copy] forKey:@"setBarTextColor:"];
}
